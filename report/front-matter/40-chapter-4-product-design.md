...
El prototipo de escritorio demuestra los flujos principales de la experiencia restaurante, incluyendo navegación desde el dashboard hacia inventario, pedidos, alertas, reportes y configuración. Esta vista aprovecha mejor el espacio disponible mediante sidebar persistente, tablas amplias, paneles de resumen y accesos rápidos a acciones críticas. El objetivo del prototipo es evidenciar cómo un usuario puede monitorear y operar la plataforma con rapidez desde una interfaz centralizada.

[Imagen sugerida: `../assets/images/figma/desktop-prototype.png` — screenshot del prototipo de escritorio en Figma]
[Imagen sugerida: captura del video del prototipo de escritorio mostrando el flujo Dashboard → Inventario → Crear pedido]
[URL sugerida: enlace de Microsoft Stream del video del prototipo desktop]
[Enlace complementario: `https://www.figma.com/proto/JUBnvZfJvlrpxIpW8ICRvS/SupplyWok?node-id=428-4042&p=f&t=kGhZbpCdqH2BntGS-0&scaling=scale-down&content-scaling=fixed&page-id=428%3A2335`]

#### Mobile

El prototipo mobile concentra la experiencia en tareas de consulta rápida, actualización de estados y registro operativo desde pantallas reducidas. Las vistas se reorganizan en una sola columna y priorizan botones táctiles, tarjetas resumidas y navegación compacta. Esto permite validar que el sistema siga siendo usable para restaurantes y proveedores cuando el acceso ocurre desde dispositivos móviles.

[Imagen sugerida: `../assets/images/figma/mobile-prototype.png` — screenshot del prototipo mobile en Figma]
[Imagen sugerida: captura del video del prototipo mobile mostrando el flujo Dashboard → Pedido → Actualizar estado]
[URL sugerida: enlace de Microsoft Stream del video del prototipo mobile]
[Enlace complementario: `https://www.figma.com/proto/JUBnvZfJvlrpxIpW8ICRvS/SupplyWok?node-id=428-2336&p=f&t=kGhZbpCdqH2BntGS-0&scaling=scale-down&content-scaling=fixed&page-id=428%3A2336`]
